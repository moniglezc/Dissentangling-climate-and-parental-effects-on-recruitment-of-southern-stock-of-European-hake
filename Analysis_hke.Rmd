...
vars<-c("rec_value","ssb_val","L50_females","shannon_females","shannon_females_s1", "shannon_females_s2", "shannon_females_s3", "shannon_females_s4","sst","nao","amo")
...
jarque.bera.test(resid(u4)) redundante con shapiro
...
dev_exp<-c(summary(p1)$dev.expl,summary(u2)$dev.expl,summary(u3)$dev.expl,summary(u4)$dev.expl)
...
p1<-ggplot(model_clean,aes(x=year,y=rec_value))+
